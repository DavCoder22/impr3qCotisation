        ...
        <table class="table is-fullwidth">
          ...
          <tbody>
            <tr v-for="pedido in pedidos" :key="pedido.id">
              <td>{{ pedido.id }}</td>
              <td>
                <input type="number" v-model="pedido.volumen" @change="updatePedido(pedido)" class="input">
              </td>
              <td>
                <input type="number" v-model="pedido.peso" @change="updatePedido(pedido)" class="input">
              </td>
              <td>
                <input type="number" v-model="pedido.tiempo" @change="updatePedido(pedido)" class="input">
              </td>
              <td>
                <select v-model="pedido.tipo_filamento" @change="updatePedido(pedido)" class="input">
              ...
              <td>
                <select v-model="pedido.acabados" @change="updatePedido(pedido)" class="input">
                  <option value="true">Sí</option>
                  <option value="false">No</option>
                </select>
              </td>
              <td>
                <input type="number" v-model="pedido.envio" @change="updatePedido(pedido)" class="input">
              </td>
              <td>
                <select v-model="pedido.estado_id" @change="updateEstado(pedido)" class="input">
    ...
    methods: {
      ...
      async recalcularPrecio(pedido) {
        try {
          ...
          pedido.total_final = response.data.total_final;
        } catch (error) {
